...
namespace Visiology.DataCollect.Autotests.API.Tests.MeasureGroups.Post.v2
{
    ...
    /// </summary>
    [XApiVersion("2.0")]
    public class DetailsSearchElementsTests : BaseTests<ElementsListWithDetailsDto, ElementWithDetailsDto>
    {
        ...
        public DetailsSearchElementsTests(TokenFixture tokenFixture, RestService restService)
            : base(tokenFixture, restService)
        {
            Url = $"{config.GetValue("ApiUrl")}{config.GetValue("ApiUrlMeasureGroupElementsDetailsSearchPath")}";
        }
