...
namespace Visiology.DataCollect.Autotests.API.Tests.Dimensions.Put
{
    /// <summary>
    ...
    {
        public BaseIntegrationPutTests(TokenFixture tokenFixture, RestService restService, IVerifier<TEntity> verifier = null)
