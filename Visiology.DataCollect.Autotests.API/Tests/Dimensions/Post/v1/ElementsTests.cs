...
namespace Visiology.DataCollect.Autotests.API.Tests.Dimensions.Post.v1
{
    ...
    public class ElementsTests : BaseIntegrationPostTests<ElementsListDto, ElementDto>
    {
        ...
        /// В дампе - "Тестовое измерение для тестирования создания элементов"
        /// </summary>
        protected virtual string userDimensionId { get; set; } = "28";
            ...
            if (result.IsSuccess)
            {
                ...
                var expectedElementsInfo = new List<ElementDto>()
                {
                    new ElementDto
                    {
                        ...
                        {
                            new ElementAttributeDto { AttributeId = "120", Value = null },
                            new ElementAttributeDto { AttributeId = "121", Value = null },
                            new ElementAttributeDto { AttributeId = "122", Value = null },
                            new ElementAttributeDto { AttributeId = "123", Value = null },
                            new ElementAttributeDto { AttributeId = "124", Value = null },
                            new ElementAttributeDto { AttributeId = "125", Value = null }
                        }
                    }
                };
        ...
        public async Task Create_WithAttributes(TokenRoleType token)
        {
            var body = new[]
           {
                new
                {
                   ...
                   Attributes = new []
                   {
                       new { AttributeId = 120, Value = "1" },
                       new { AttributeId = 121, Value = "Элемент для проверки создания c атрибутами" },
                       new { AttributeId = 122, Value = "1.00" },
                       new { AttributeId = 123, Value = "2018-07-11" },
                       new { AttributeId = 124, Value = "1" },
                       new { AttributeId = 125, Value = "Элемент для проверки создания c атрибутами" }
                   }
                }
            };
            ...
            if (result.IsSuccess)
            {
                ...
                var expectedElementsInfo = new List<ElementDto>()
                {
                    new ElementDto
                    {
                        ...
                        Attributes = new List<ElementAttributeDto>
                        {
                            new ElementAttributeDto { AttributeId = "120", Value = 1 },
                            new ElementAttributeDto { AttributeId = "121", Value = "Элемент для проверки создания c атрибутами" },
                            new ElementAttributeDto { AttributeId = "122", Value = 1.00 },
                            new ElementAttributeDto { AttributeId = "123", Value = "2018-07-11" },
                            new ElementAttributeDto { AttributeId = "124", Value = 1 },
                            new ElementAttributeDto { AttributeId = "125", Value = "Элемент для проверки создания c атрибутами" }
                        }
                    }
                };
